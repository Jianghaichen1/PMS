<template>
    <div class="book">
		...
		<el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
       	 ...
       	 <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addBook">添加</el-button>
		...
		<!--2.表格数据展示区域区域-->
		<div class="wrapper">
			<el-table :data="tableData" style="font-size: 20px;" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="id"  sortable prop="id" label="编号" width="100"  show-overflow-tooltip>
     			 </el-table-column>
				 <el-table-column class="type"  prop="type" label="类型" width="100" >
     			 </el-table-column>
      		
      			 <el-table-column  prop="name" label="知识名" width="200">
      			 </el-table-column>
				 
      			 <el-table-column  prop="content" label="内容" width="679">
      			 </el-table-column>
				   <el-table-column prop="time" sortable  label="时间" width="100" show-overflow-tooltip>
     			 </el-table-column>
				 <el-table-column  prop="hname" label="专家" width="65">
      			 </el-table-column>
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
		...
		-->
		<BookDialog ref="dialog" :title="title" :rowData="rowData" />
...
<script >
	...
	methods:{
			...
			handleEdit(index,row){
				...
				//传递数据
				// this.rowData = { ...row };
     			this.$refs.dialog.bookForm=row;  //方法1：
			},
			//删除
