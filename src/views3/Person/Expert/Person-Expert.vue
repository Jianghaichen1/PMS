		...
		<el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
				...
				<el-menu-item>	
					<el-button  class="b1"  icon="el-icon-search" >查询</el-button>
         	        <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addExpert">添加</el-button>
				</el-menu-item>
		...
		<div class="wrapper">
			<el-table :data="tableData" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="id"  sortable prop="id" label="编号" width="100"  show-overflow-tooltip>
     			 </el-table-column>
				 <el-table-column   sortable prop="username" label="账号" width="100" >
     			 </el-table-column>
                  <el-table-column   prop="password" label="密码" width="100" >
     			 </el-table-column>
				   <el-table-column class="name"  prop="name" label="姓名" width="100" >
     			 </el-table-column>
				 ...
				 <el-table-column  prop="time" label="出生日期" width="150">
				  </el-table-column>
      			 <el-table-column prop="ji" label="简介" width="300">
				</el-table-column>
                <el-table-column  prop="hobby" label="擅长" width="150">
				  </el-table-column>
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
		...
		-->
		<ExpertDialog ref="dialog" :title="title" :rowData="rowData" />
...
<script >
	...
	import ExpertDialog from './ExpertDialog.vue';
	...
	methods:{
			...
			handleEdit(index,row){
				...
				this.title = "编辑用户信息";
				this.rowData = { ...row };
    			this.$refs.dialog.expertForm = row;//方法1：
			},
			//删除
