               ...
               label-width="100px"
                class="demo-adminForm">
                    ...
                    <el-form-item label="账号"  prop="username">
                      <el-input v-model="adminForm.username" label-width="200px"></el-input>
                  </el-form-item>
                  <el-form-item label="密码"  prop="password">
                      <el-input v-model="adminForm.password" label-width="200px"></el-input>
                  </el-form-item>
                    <el-form-item label="姓名"  prop="name">
                      <el-input v-model="adminForm.name" label-width="200px"></el-input>
                  </el-form-item>
                ...
                <el-form-item label="出生日期" style="margin-left:30px ;"  required>
                    ...
                    <el-form-item  prop="time">
                        <el-date-picker type="date" placeholder="选择日期" v-model="adminForm.time" style="width: 100%;"></el-date-picker>
                    </el-form-item>
                    </el-col>      
                </el-form-item>    
                <el-form-item label="手机"  prop="phone">
                 ...
                 <el-form-item label="简介"  prop="ji">
                    <el-input v-model="adminForm.ji"></el-input>
                </el-form-item>
                <el-form-item label="擅长"  prop="hobby">
                    <el-input v-model="adminForm.hobby"></el-input>
                </el-form-item>
   ...
   methods:{
      ...
      submitForm() {
        this.$refs.adminForm.validate((valid) => {
          if (valid) {
            console.log("获取输入的信息", this.adminForm);
