  ...
  <el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
      ...
      <el-menu-item>	
        <el-button  class="b1"  icon="el-icon-search" >查询</el-button>
                 <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addAdmin">添加</el-button>
      </el-menu-item>
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
  ...
  -->
  <AdminDialog ref="dialog" :title="title" :rowData="rowData" />
...
methods:{
    ...
    handleEdit(index,row){
      ...
      this.title = "编辑用户信息";
      this.rowData = { ...row };
        this.$refs.dialog.adminForm = row;//方法1：
    },
    //删除
