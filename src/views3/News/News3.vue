		...
		<el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
				...
				<el-menu-item>	
					<el-button  class="b1"  icon="el-icon-search" >查询</el-button>
         	        <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addNews">添加</el-button>
				</el-menu-item>
		...
		<div class="wrapper">
			<el-table :data="tableData" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="id"  sortable prop="id" label="编号" width="80"  show-overflow-tooltip>
     			 </el-table-column>
		
				   <el-table-column class="title"  prop="title" label="名称" width="500" >
     			 </el-table-column>
				   <el-table-column  prop="text" label="内容" width="720">
				  </el-table-column>   
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
		...
		-->
		<NewsDialog ref="dialog" :title="title" :rowData="rowData" />
...
<script >
	...
	methods:{
			...
			handleEdit(index,row){
				...
				this.title = "编辑新闻信息";
				this.rowData = { ...row };
    			this.$refs.dialog.newsForm = row;//方法1：
			},
			//删除
