			...
			<el-table :data="tableData" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="id"  sortable prop="id" label="编号" width="100"  show-overflow-tooltip>
				   ...
				   <el-table-column class="name"  prop="name" label="姓名" width="200" >
     			 </el-table-column>
				 <el-table-column  prop="time" label="日期" width="250">
				  </el-table-column>
      			 <el-table-column prop="text" label="信息" width="500">
				</el-table-column>
                <el-table-column  prop="type" label="状态" width="250">
				  </el-table-column>
